 ...
 * 的修改以实现动画效果
 */
public class GameDefenderViewThread extends Thread{
	public GameDefenderView father;				//WelcomeView对象的引用
	...
	//构造器：初始化主要成员变量	
	public GameDefenderViewThread(GameDefenderView father,SurfaceHolder surfaceHolder){
		this.father = father;
